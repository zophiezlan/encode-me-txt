...
import {
  encodeOrigamiCrease,
  decodeOrigamiCrease,
  encodeConstellationMap,
  decodeConstellationMap,
  encodeTectonicPlate,
  decodeTectonicPlate,
  encodeMyceliumNetwork,
  decodeMyceliumNetwork,
  encodeBioluminescence,
  decodeBioluminescence,
  encodeAuroraBorealis,
  decodeAuroraBorealis,
  encodeWaggleDance,
  decodeWaggleDance,
  encodeGlacierStratigraphy,
  decodeGlacierStratigraphy,
  encodeWindRose,
  decodeWindRose,
  encodeDendrochronology,
  decodeDendrochronology,
  encodeCoralReef,
  decodeCoralReef,
  encodeBirdMigration,
  decodeBirdMigration,
  encodeErosionPattern,
  decodeErosionPattern,
  encodeAuroraAustralis,
  decodeAuroraAustralis,
  encodeSnowflakeCrystal,
  decodeSnowflakeCrystal,
  encodeBonsaiGrowth,
  decodeBonsaiGrowth,
...
import {
  encodeFluidDynamics,
  decodeFluidDynamics,
  encodeCrystallography,
  decodeCrystallography,
  encodeSeismograph,
  decodeSeismograph,
  encodeMagneticField,
  decodeMagneticField,
  encodeSupernovaRemnant,
  decodeSupernovaRemnant,
  encodeCircadianRhythm,
  decodeCircadianRhythm,
  encodeHolographicInterference,
  decodeHolographicInterference,
  encodeFermentation,
  decodeFermentation,
  encodeNeurotransmitter,
  decodeNeurotransmitter,
  encodeMantleConvection,
  decodeMantleConvection,
